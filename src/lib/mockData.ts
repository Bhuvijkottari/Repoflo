...
export const mockPortfolioData: PortfolioData = {
  ...
  experience: [
    ...
    },
    {
      ...
      period: "2021 - 2023",
      description: "Built core features including real-time collaboration and payment integration.",
    },
    {
      company: "WebAgency",
  ...
  projects: [
    {
      name: "TaskFlow",
      description: "A real-time project management tool with Kanban boards and team collaboration.",
    ...
    {
      name: "CodeSnap",
      description: "Beautiful code screenshot generator with syntax highlighting and themes.",
      tech: ["TypeScript", "Canvas API", "Prism.js"],
      stars: 567,
      link: "https://github.com/alexjohnson/codesnap",
    },
    {
      name: "WeatherCast",
      description: "AI-powered weather forecasting app with interactive maps.",
      tech: ["Python", "FastAPI", "React", "TensorFlow"],
      stars: 128,
      link: "https://github.com/alexjohnson/weathercast",
    },
    {
      name: "DevBlog",
      description: "Markdown-powered blog platform with MDX support and analytics.",
      tech: ["Next.js", "MDX", "Vercel"],
      stars: 89,
      link: "https://github.com/alexjohnson/devblog",
    },
  ],
  volunteering: [
    {
      ...
      role: "Lead Mentor",
      period: "2022 - Present",
      description: "Mentoring underrepresented students in web development.",
    },
  ],
  githubStats: {
    totalCommits: 2847,
