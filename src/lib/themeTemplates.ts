      ...
      return wrapTheme(
        ...
        <section id="ry-home" class="ry-snap" style="background:linear-gradient(160deg,#1e1b4b,#312e81,#1e1b4b);text-align:center">
          <div style="max-width:700px;margin:0 auto;position:relative;z-index:1">
            ...
            <p style="color:#4c4a7a;max-width:440px;margin:0 auto;line-height:1.85;font-weight:300">${d.bio}</p>
          </div>
        ...
        <section id="ry-contact" class="ry-snap" style="background:linear-gradient(160deg,#1a1848,#312e81);text-align:center">
          <div style="max-width:600px;margin:0 auto">
            ...
            <p style="color:#4c4a7a;margin-top:12px;font-size:.85rem">${d.location}</p>
            ${d.education.length?`<div style="margin-top:28px;border-top:1px solid rgba(129,140,248,.1);padding-top:20px">${d.education.map((e:{degree:string,institution:string,period:string})=>`<p style="color:#4c4a7a;font-size:.83rem"><strong style="color:#a5b4fc">${e.degree}</strong> · ${e.institution}</p>`).join('')}</div>`:''}
          </div>
        </section>
        </div>
        <script>
